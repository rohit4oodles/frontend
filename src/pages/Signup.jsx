...
import Verify_mail from "./verify_mail";
...
const Signup = ({}) => {
  ...
  const[singnup,setsinghup]=useState(true)
  ...
  const handlesubmit = async (e) => {
    ...
    formet.append("first_name",first_name);
    formet.append("last_name",last_name);
    formet.append("email",email);
    formet.append("password",password);
    formet.append("user_bio",user_bio);
    formet.append("user_profile_image", image);
    console.log(image,"****************")
    if (!passwordValidation.test(password)){
      toast.warning("password sohuld be 8 digit long and contain numeric alphabet and a special symbol")    }
    else{
      try{
        const responce = await fetch("https://rohitmaurya15.pythonanywhere.com/user/create/",{
          method:"POST",
          headers:{},
          body:formet,
        });
          ...
          />
            ...
            <div className="mb-10">
              <button
                ...
                className="w-full cursor-pointer rounded-md border border-primary bg-primary px-5 py-3 text-base font-medium text-blue-700 transition hover:bg-opacity-90">Submit</button>
